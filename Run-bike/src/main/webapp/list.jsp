...
<div id="editFrame" style="display: none" >
	 ...
	 <div id="detailFrame" style="display: none">
          ...
          <div class="row">
	          <div class="form-group">
	           <label>내용</label>
	           <textarea name="q_content" id="dq_content" class="form-control" rows="10" readonly ></textarea>
	          </div>
	  		 </div>
			...
			//답글 작성폼
 		    function replywrite(q_num){
 		       ...
 		       /*  html += '<input type="hidden" value="'+u_idx+'" id="u_idx" name="u_idx">'; */
 		        ...
 		        html += '<div class="form-group col-lg-5"><label for="rp_writer">작성자</label><textarea class="form-control"  placeholder="관리자" id="rp_writer" name="rp_writer" col="100" readonly></textarea></div>';
