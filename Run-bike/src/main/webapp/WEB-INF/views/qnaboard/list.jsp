	            ...
	            <!-- <input type="hidden" name="q_num" id="dq_num"> -->
		            ...
		            <table id=detailTable>
						<tr>
				            ...
				            <input type="text" name="regdate" id="dregdate" class="form-control" value="${boardData.regdate}" readonly/>
				            
				            <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${boardData.regdate}"/>
				            </td>
