...
<body>
	...
	<div class="row mb-md-5" >
		<div class="list-group list-group-horizontal col-md-4 col-sm-12 mx-auto text-center" id="myList" role="tablist">
			...
			<a class="list-group-item list-group-item-action active" id="adminBadge" data-toggle="list" id="ridingGuide" href="#" role="tab">뱃지관리</a> 
			<a class="list-group-item list-group-item-action" id="adminStamp" data-toggle="list" id="myCourse" href="#" role="tab">스탬프 관리</a>
		</div>
	</div>
	
	<!-- 컨테이너 시작 -->
	<div class="container">
			<h4 class="font-weight-bold pt-5 mb-4"><i class="fas fa-map-marked-alt"> 뱃지 관리</i></h4>
			<div class="page-info-text text-dark">현재 뱃지를 조회합니다.</div>
			<hr>		
	</div>
