package com.teamrun.runbike.stamp.domain;
...
public class Stamp {
	...
	public String toString() {
		return "Stamp [s_num=" + s_num + ", s_name=" + s_name + ", s_photo=" + s_photo + ", cs_photo=" + cs_photo
				+ ", s_point_lon=" + s_point_lon + ", s_point_lat=" + s_point_lat + "]";
	}
