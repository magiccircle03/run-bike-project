...
public class MailSenderService implements UserService {
	...
	public void mailSend(String u_id, String u_code,String u_name) {
		...
		try {
			...
			String html = "<h1>회원가입을 축하드립니다.</h1><p>안녕하세요. "+u_name+" 님. <br> 이메일 계정을 인증 받으시려면 아래 링크를 클립해주세요.</p><a href='http://localhost:8080/runbike/mail/verify?id="+u_id+"&code="+u_code+"'>이메일 인증하기</a>";
	...
	public void mailResend(String u_id, String u_code, String u_name) {
//		MimeMessage message = sender.createMimeMesssge();
